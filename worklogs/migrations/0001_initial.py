    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('worklog_type', models.CharField(choices=[('Worklog', 'Worklog'), ('LeaveLog', 'Leavelog')], default='Worklog', max_length=20)),
                ('worklog_status', models.CharField(choices=[('Pending', 'Pending'), ('Approved', 'Approved'), ('Billed', 'Billed')], default='Pending', max_length=20)),
                ...
                ('worklog_detail_id', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='worklogs.worklogdetails')),
            ],
        ),
    ]
